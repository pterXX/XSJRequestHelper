...
static NSString *const kXSJNetworkResponseCache = @"kXSJNetworkResponseCache";

@implementation XSJNetworkCache
static YYCache *_dataCache;

+ (void)initialize {
    _dataCache = [YYCache cacheWithName:kXSJNetworkResponseCache];
}
